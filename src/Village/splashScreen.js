...
export const splashScreen = function (scene) {
  ...
  const frText = scene.add
    .bitmapText(220, 160, "FreePixel-16", "Français", 16)
    .setOrigin(0.5, 0.5)
    .setTintFill(0xffffff)
    .setInteractive({ useHandCursor: true });

  frText.input.hitArea.setTo(-20, -20, frText.width + 40, frText.height + 40);
  ...
  const enText = scene.add
    .bitmapText(330, 160, "FreePixel-16", "English", 16)
    .setOrigin(0.5, 0.5)
    .setTintFill(0xffffff)
    .setInteractive({ useHandCursor: true });

  enText.input.hitArea.setTo(-20, -20, enText.width + 40, enText.height + 40);
